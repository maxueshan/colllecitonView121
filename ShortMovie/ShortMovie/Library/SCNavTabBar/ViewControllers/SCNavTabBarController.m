...
- (void)viewInit
{
    ...
    // 顶部横条滚动视图设置
    _navTabBar = [[SCNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE + 0, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT ) showArrowButton:_showArrowButton];
